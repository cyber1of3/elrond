...
sudo git clone https://github.com/cyberg3cko/KStrike.git /opt/KStrike
sudo rm -rf /opt/plaso
sudo git clone https://github.com/log2timeline/plaso.git /opt/plaso
sudo rm -rf /opt/etl-parser
sudo git clone https://github.com/cyberg3cko/etl-parser /opt/etl-parser
sudo rm -rf /opt/bruce
sudo git clone https://github.com/cyberg3cko/bruce.git /opt/bruce
sudo rm -rf /opt/bookstack
sudo git clone https://github.com/BookStackApp/BookStack.git /opt/bookstack
sudo rm -rf /opt/gandalf
sudo git clone https://github.com/cyberg3cko/gandalf.git /opt/gandalf
...
sudo git clone https://github.com/cyberg3cko/WMI_Forensics /opt/WMI_Forensics
...
sudo rm -rf /opt/rdap
sudo git clone https://github.com/cyberg3cko/rdap.git /opt/rdap
